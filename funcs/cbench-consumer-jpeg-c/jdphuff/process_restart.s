...
# %bb.0:                                # %"0"
	...
	.cfi_offset %rbx, -32
	.cfi_offset %r14, -24
	movabsq	$__profd_.._jdphuff.c_process_restart, %rsi
	movq	%rdi, -40(%rbp)
	movq	-40(%rbp), %rax
	movq	576(%rax), %rax
	movq	%rax, -32(%rbp)
...
# %bb.5:                                # %"5"
	...
	jmp	.LBB0_3
.LBB0_6:                                # %"6"
	movq	__profc_.._jdphuff.c_process_restart+8, %rax
	addq	$1, %rax
	movq	%rax, __profc_.._jdphuff.c_process_restart+8
	movq	-32(%rbp), %rax
	movl	$0, 32(%rax)
	movq	-40(%rbp), %rax
	movl	360(%rax), %eax
...
.Lfunc_end0:
	...
	.hidden	__profd_.._jdphuff.c_process_restart
