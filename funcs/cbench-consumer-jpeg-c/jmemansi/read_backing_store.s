	.text
	.file	"jmemansi.c"
	.hidden	read_backing_store      # -- Begin function read_backing_store
	.globl	read_backing_store
	.p2align	4, 0x90
...
# %bb.0:                                # %"0"
	...
	.cfi_offset %rbx, -32
	.cfi_offset %r14, -24
	movq	__profc_.._jmemansi.c_read_backing_store, %rax
	addq	$1, %rax
	movq	%rax, __profc_.._jmemansi.c_read_backing_store
	movq	%rdi, -24(%rbp)
	movq	%rsi, -40(%rbp)
	movq	%rdx, -56(%rbp)
	movq	%rcx, -48(%rbp)
...
.LBB0_4:                                # %"4"
	...
	retq
.Lfunc_end0:
	.size	read_backing_store, .Lfunc_end0-read_backing_store
	.cfi_endproc
                                        # -- End function
