...
.LBB0_4:                                # %"4"
	...
	jle	.LBB0_6
# %bb.5:                                # %"5"
	movq	__profc_.._jcmaster.c_per_scan_setup+80, %rax
	addq	$1, %rax
	movq	%rax, __profc_.._jcmaster.c_per_scan_setup+80
	movq	-24(%rbp), %rax
	cmpl	$4, 316(%rax)
	jle	.LBB0_7
.LBB0_6:                                # %"6"
	movabsq	$__profd_.._jcmaster.c_per_scan_setup, %rsi
	movq	__profc_.._jcmaster.c_per_scan_setup+56, %rax
	addq	$1, %rax
	movq	%rax, __profc_.._jcmaster.c_per_scan_setup+56
	movq	-24(%rbp), %rax
	movq	(%rax), %rax
	movl	$24, 40(%rax)
	movq	-24(%rbp), %rax
...
# %bb.9:                                # %"9"
	...
	movq	__profc_.._jcmaster.c_per_scan_setup+8, %rax
	addq	$1, %rax
	movq	%rax, __profc_.._jcmaster.c_per_scan_setup+8
	movq	-24(%rbp), %rax
	movslq	-40(%rbp), %rcx
...
# %bb.10:                               # %"10"
                                        #   in Loop: Header=BB0_8 Depth=1
	movq	__profc_.._jcmaster.c_per_scan_setup+24, %rax
	addq	$1, %rax
	movq	%rax, __profc_.._jcmaster.c_per_scan_setup+24
	movq	-32(%rbp), %rax
	movl	52(%rax), %eax
	movl	%eax, -36(%rbp)
.LBB0_11:                               # %"11"
...
# %bb.12:                               # %"12"
                                        #   in Loop: Header=BB0_8 Depth=1
	movq	__profc_.._jcmaster.c_per_scan_setup+32, %rax
	addq	$1, %rax
	movq	%rax, __profc_.._jcmaster.c_per_scan_setup+32
	movq	-32(%rbp), %rax
	movl	56(%rax), %eax
	movl	%eax, -36(%rbp)
.LBB0_13:                               # %"13"
...
.LBB0_19:                               # %"19"
	...
	jmp	.LBB0_8
.LBB0_20:                               # %"20"
	movq	__profc_.._jcmaster.c_per_scan_setup+48, %rax
	addq	$1, %rax
	movq	%rax, __profc_.._jcmaster.c_per_scan_setup+48
.LBB0_21:                               # %"21"
	movq	-24(%rbp), %rax
	cmpl	$0, 276(%rax)
	jle	.LBB0_26
...
# %bb.23:                               # %"23"
	...
	jmp	.LBB0_25
.LBB0_24:                               # %"24"
	movq	__profc_.._jcmaster.c_per_scan_setup+72, %rax
	addq	$1, %rax
	movq	%rax, __profc_.._jcmaster.c_per_scan_setup+72
...
.Lfunc_end0:
	...
	.hidden	__profd_.._jcmaster.c_per_scan_setup
