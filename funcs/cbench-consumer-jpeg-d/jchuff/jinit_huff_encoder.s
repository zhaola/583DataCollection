...
# %bb.0:                                # %"0"
	...
	.cfi_offset %rbx, -32
	.cfi_offset %r14, -24
	movabsq	$__profd_jinit_huff_encoder, %rsi
	movq	__profc_jinit_huff_encoder+8, %rax
	addq	$1, %rax
	movq	%rax, __profc_jinit_huff_encoder+8
	movq	%rdi, -40(%rbp)
	movq	-40(%rbp), %rax
	movq	8(%rax), %rax
	movq	(%rax), %rbx
...
.Lfunc_end0:
	...
	.hidden	__profd_jinit_huff_encoder
	.hidden	start_pass_huff
