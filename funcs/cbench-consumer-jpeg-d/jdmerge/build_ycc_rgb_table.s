...
# %bb.0:                                # %"0"
	...
	.cfi_offset %rbx, -32
	.cfi_offset %r14, -24
	movabsq	$__profd_.._jdmerge.c_build_ycc_rgb_table, %rsi
	movq	__profc_.._jdmerge.c_build_ycc_rgb_table+8, %rax
	addq	$1, %rax
	movq	%rax, __profc_.._jdmerge.c_build_ycc_rgb_table+8
	movq	%rdi, -32(%rbp)
	movq	-32(%rbp), %rax
	movq	592(%rax), %rax
	movq	%rax, -40(%rbp)
...
# %bb.3:                                # %"3"
                                        #   in Loop: Header=BB0_1 Depth=1
	movq	__profc_.._jdmerge.c_build_ycc_rgb_table, %rax
	addq	$1, %rax
	movq	%rax, __profc_.._jdmerge.c_build_ycc_rgb_table
	movl	-20(%rbp), %eax
	addl	$1, %eax
	movl	%eax, -20(%rbp)
	movq	-48(%rbp), %rax
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        # -- End function
	.hidden	__profc_.._jdmerge.c_build_ycc_rgb_table
	.hidden	__profd_.._jdmerge.c_build_ycc_rgb_table
