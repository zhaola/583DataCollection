...
# %bb.0:                                # %"0"
	...
	subq	$32, %rsp
	movq	__profc_.._symm.c_print_array+24, %rax
	addq	$1, %rax
	movq	%rax, __profc_.._symm.c_print_array+24
	movl	%edi, -12(%rbp)
	movl	%esi, -16(%rbp)
	movq	%rdx, -24(%rbp)
	movl	$0, -8(%rbp)
...
# %bb.5:                                # %"5"
                                        #   in Loop: Header=BB0_3 Depth=2
	movq	__profc_.._symm.c_print_array+8, %rax
	addq	$1, %rax
	movq	%rax, __profc_.._symm.c_print_array+8
	movq	stderr, %rdi
	movabsq	$.str.2, %rsi
	movb	$0, %al
	callq	fprintf
