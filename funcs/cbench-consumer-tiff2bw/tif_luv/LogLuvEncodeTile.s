	.text
	.file	"tif_luv.c"
	.hidden	LogLuvEncodeTile        # -- Begin function LogLuvEncodeTile
	.globl	LogLuvEncodeTile
	.p2align	4, 0x90
	.type	LogLuvEncodeTile,@function
LogLuvEncodeTile:                       # @LogLuvEncodeTile
	.cfi_startproc
# %bb.0:                                # %"0"
	pushq	%rbp
...
# %bb.5:                                # %"5"
	...
	movabsq	$__profd_.._tif_luv.c_LogLuvEncodeTile, %rsi
	movq	__profc_.._tif_luv.c_LogLuvEncodeTile+8, %rax
	addq	$1, %rax
	movq	%rax, __profc_.._tif_luv.c_LogLuvEncodeTile+8
	movq	-72(%rbp), %rax
	movq	624(%rax), %rbx
	movq	-72(%rbp), %r14
	movq	-64(%rbp), %r15
...
.LBB0_8:                                # %"8"
	...
	retq
.Lfunc_end0:
	.size	LogLuvEncodeTile, .Lfunc_end0-LogLuvEncodeTile
	.cfi_endproc
                                        # -- End function
	.hidden	.str.1
	.hidden	.str.17
