...
# %bb.0:                                # %"0"
	...
	movq	__profc_.._durbin.c_init_array+16, %rax
	addq	$1, %rax
	movq	%rax, __profc_.._durbin.c_init_array+16
	movl	%edi, -12(%rbp)
	movq	%rsi, -56(%rbp)
	movq	%rdx, -48(%rbp)
	movq	%rcx, -40(%rbp)
...
# %bb.5:                                # %"5"
                                        #   in Loop: Header=BB0_3 Depth=2
	movq	__profc_.._durbin.c_init_array, %rax
	addq	$1, %rax
	movq	%rax, __profc_.._durbin.c_init_array
	movl	-8(%rbp), %eax
	addl	$1, %eax
	movl	%eax, -8(%rbp)
	jmp	.LBB0_3
