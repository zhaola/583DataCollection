...
# %bb.0:                                # %"0"
	...
	subq	$16, %rsp
	movq	__profc_.._ludcmp.c_print_array+16, %rax
	addq	$1, %rax
	movq	%rax, __profc_.._ludcmp.c_print_array+16
	movl	%edi, -8(%rbp)
	movq	%rsi, -16(%rbp)
	movl	$0, -4(%rbp)
.LBB0_1:                                # %"1"
...
.LBB0_5:                                # %"5"
                                        #   in Loop: Header=BB0_1 Depth=1
	movq	__profc_.._ludcmp.c_print_array, %rax
	addq	$1, %rax
	movq	%rax, __profc_.._ludcmp.c_print_array
	movl	-4(%rbp), %eax
	addl	$1, %eax
	movl	%eax, -4(%rbp)
	jmp	.LBB0_1
