	.text
	.file	"tif_luv.c"
	.hidden	LogLuvDecodeStrip       # -- Begin function LogLuvDecodeStrip
	.globl	LogLuvDecodeStrip
	.p2align	4, 0x90
	.type	LogLuvDecodeStrip,@function
LogLuvDecodeStrip:                      # @LogLuvDecodeStrip
	.cfi_startproc
# %bb.0:                                # %"0"
	pushq	%rbp
...
# %bb.5:                                # %"5"
	...
	movabsq	$__profd_.._tif_luv.c_LogLuvDecodeStrip, %rsi
	movq	__profc_.._tif_luv.c_LogLuvDecodeStrip+8, %rax
	addq	$1, %rax
	movq	%rax, __profc_.._tif_luv.c_LogLuvDecodeStrip+8
	movq	-72(%rbp), %rax
	movq	616(%rax), %rbx
	movq	-72(%rbp), %r14
	movq	-64(%rbp), %r15
...
.LBB0_8:                                # %"8"
	...
	retq
.Lfunc_end0:
	.size	LogLuvDecodeStrip, .Lfunc_end0-LogLuvDecodeStrip
	.cfi_endproc
                                        # -- End function
	.hidden	.str.1
	.hidden	.str.17
	...
	.hidden	__profd_.._tif_luv.c_LogLuvDecodeStrip
