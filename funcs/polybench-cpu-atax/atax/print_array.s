...
# %bb.0:                                # %"0"
	...
	subq	$16, %rsp
	movq	__profc_.._atax.c_print_array+16, %rax
	addq	$1, %rax
	movq	%rax, __profc_.._atax.c_print_array+16
	movl	%edi, -8(%rbp)
	movq	%rsi, -16(%rbp)
	movl	$0, -4(%rbp)
.LBB0_1:                                # %"1"
...
# %bb.3:                                # %"3"
                                        #   in Loop: Header=BB0_1 Depth=1
	movq	__profc_.._atax.c_print_array+8, %rax
	addq	$1, %rax
	movq	%rax, __profc_.._atax.c_print_array+8
	movq	stderr, %rdi
	movabsq	$.str.2, %rsi
	movb	$0, %al
	callq	fprintf
