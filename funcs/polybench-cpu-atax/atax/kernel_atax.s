	.text
	.file	"atax.c"
	.hidden	kernel_atax             # -- Begin function kernel_atax
	.globl	kernel_atax
	.p2align	4, 0x90
...
# %bb.3:                                # %"3"
                                        #   in Loop: Header=BB0_1 Depth=1
	movq	__profc_.._atax.c_kernel_atax+16, %rax
	addq	$1, %rax
	movq	%rax, __profc_.._atax.c_kernel_atax+16
	movl	-4(%rbp), %eax
	addl	$1, %eax
	movl	%eax, -4(%rbp)
	jmp	.LBB0_1
...
# %bb.9:                                # %"9"
                                        #   in Loop: Header=BB0_7 Depth=2
	movq	__profc_.._atax.c_kernel_atax, %rax
	addq	$1, %rax
	movq	%rax, __profc_.._atax.c_kernel_atax
	movl	-8(%rbp), %eax
	addl	$1, %eax
	movl	%eax, -8(%rbp)
	jmp	.LBB0_7
...
.LBB0_16:                               # %"16"
	...
	retq
.Lfunc_end0:
	.size	kernel_atax, .Lfunc_end0-kernel_atax
	.cfi_endproc
                                        # -- End function
