...
# %bb.0:                                # %"0"
	...
	subq	$32, %rsp
	movq	__profc_.._doitgen.c_print_array+32, %rax
	addq	$1, %rax
	movq	%rax, __profc_.._doitgen.c_print_array+32
	movl	%edi, -24(%rbp)
	movl	%esi, -20(%rbp)
	movl	%edx, -16(%rbp)
	movq	%rcx, -32(%rbp)
...
.LBB0_9:                                # %"9"
                                        #   in Loop: Header=BB0_5 Depth=3
	movq	__profc_.._doitgen.c_print_array, %rax
	addq	$1, %rax
	movq	%rax, __profc_.._doitgen.c_print_array
	movl	-8(%rbp), %eax
	addl	$1, %eax
	movl	%eax, -8(%rbp)
	jmp	.LBB0_5
...
.LBB0_13:                               # %"13"
                                        #   in Loop: Header=BB0_1 Depth=1
	movq	__profc_.._doitgen.c_print_array+24, %rax
	addq	$1, %rax
	movq	%rax, __profc_.._doitgen.c_print_array+24
	movl	-4(%rbp), %eax
	addl	$1, %eax
	movl	%eax, -4(%rbp)
	jmp	.LBB0_1
