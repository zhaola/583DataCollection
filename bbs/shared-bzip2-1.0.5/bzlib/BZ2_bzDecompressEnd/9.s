	.text
	.file	"bzlib.c"
	.globl	BZ2_bzDecompressEnd.9   # -- Begin function BZ2_bzDecompressEnd.9
	.p2align	4, 0x90
	.type	BZ2_bzDecompressEnd.9,@function
BZ2_bzDecompressEnd.9:                  # @BZ2_bzDecompressEnd.9
	.cfi_startproc
# %bb.0:                                # %newFuncRoot
	pushq	%rbp
...
.LBB0_2:                                # %"9"
	...
	addq	$1, %rcx
	movq	%rcx, __profc_BZ2_bzDecompressEnd+40
	movq	(%rdi), %rcx
	movq	64(%rcx), %rbx
	movq	(%rdi), %rcx
	movq	72(%rcx), %r14
