	...
	.globl	astex_codelet__10.4     # -- Begin function astex_codelet__10.4
	.p2align	4, 0x90
	.type	astex_codelet__10.4,@function
astex_codelet__10.4:                    # @astex_codelet__10.4
	.cfi_startproc
# %bb.0:                                # %newFuncRoot
	pushq	%rbp
...
.LBB0_2:                                # %"4"
		...
		.byte 0x64, 0x67, 0x90
	.cfi_def_cfa %rbp, 16
	movq	__profc_astex_codelet__10+8, %rbx
	addq	$1, %rbx
	movq	%rbx, __profc_astex_codelet__10+8
	movq	(%rdi), %rbx
	...
	movsd	%xmm0, 32(%rax)
		...
		.byte 0x64, 0x67, 0x90
.Lfunc_end0:
	.size	astex_codelet__10.4, .Lfunc_end0-astex_codelet__10.4
	.cfi_endproc
                                        # -- End function
