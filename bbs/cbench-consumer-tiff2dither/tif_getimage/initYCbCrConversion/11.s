	.text
	.file	"tif_getimage.c"
	.globl	initYCbCrConversion.11  # -- Begin function initYCbCrConversion.11
	.p2align	4, 0x90
	.type	initYCbCrConversion.11,@function
initYCbCrConversion.11:                 # @initYCbCrConversion.11
	.cfi_startproc
# %bb.0:                                # %newFuncRoot
	pushq	%rbp
...
.LBB0_2:                                # %"11"
	...
	movq	%rax, (%rdi)
		...
		.byte 0x64, 0x67, 0x90
.Lfunc_end0:
	.size	initYCbCrConversion.11, .Lfunc_end0-initYCbCrConversion.11
	.cfi_endproc
                                        # -- End function
