	.text
	.file	"tif_write.c"
	.globl	TIFFWriteEncodedTile.1  # -- Begin function TIFFWriteEncodedTile.1
	.p2align	4, 0x90
	.type	TIFFWriteEncodedTile.1,@function
TIFFWriteEncodedTile.1:                 # @TIFFWriteEncodedTile.1
	.cfi_startproc
# %bb.0:                                # %newFuncRoot
	pushq	%rbp
...
.LBB0_3:                                # %"1"
	...
	cmpl	$0, %eax
		...
		.byte 0x64, 0x67, 0x90
.Lfunc_end0:
	.size	TIFFWriteEncodedTile.1, .Lfunc_end0-TIFFWriteEncodedTile.1
	.cfi_endproc
                                        # -- End function
