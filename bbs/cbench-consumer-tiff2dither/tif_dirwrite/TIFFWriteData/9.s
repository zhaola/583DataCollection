	.text
	.file	"tif_dirwrite.c"
	.globl	TIFFWriteData.9         # -- Begin function TIFFWriteData.9
	.p2align	4, 0x90
	.type	TIFFWriteData.9,@function
TIFFWriteData.9:                        # @TIFFWriteData.9
	.cfi_startproc
# %bb.0:                                # %newFuncRoot
	pushq	%rbp
...
.LBB0_2:                                # %"9"
	...
	jmp	.LBB0_1
.Lfunc_end0:
	.size	TIFFWriteData.9, .Lfunc_end0-TIFFWriteData.9
	.cfi_endproc
                                        # -- End function
