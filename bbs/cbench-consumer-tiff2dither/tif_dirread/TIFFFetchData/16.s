	.text
	.file	"tif_dirread.c"
	.globl	TIFFFetchData.16        # -- Begin function TIFFFetchData.16
	.p2align	4, 0x90
	.type	TIFFFetchData.16,@function
TIFFFetchData.16:                       # @TIFFFetchData.16
	.cfi_startproc
# %bb.0:                                # %newFuncRoot
	pushq	%rbp
...
.LBB0_2:                                # %"16"
	...
	callq	TIFFSwabArrayOfLong
		...
		.byte 0x64, 0x67, 0x90
.Lfunc_end0:
	.size	TIFFFetchData.16, .Lfunc_end0-TIFFFetchData.16
	.cfi_endproc
                                        # -- End function
