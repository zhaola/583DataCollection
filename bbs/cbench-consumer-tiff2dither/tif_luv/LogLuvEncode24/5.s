	.text
	.file	"tif_luv.c"
	.globl	LogLuvEncode24.5        # -- Begin function LogLuvEncode24.5
	.p2align	4, 0x90
	.type	LogLuvEncode24.5,@function
LogLuvEncode24.5:                       # @LogLuvEncode24.5
	.cfi_startproc
# %bb.0:                                # %newFuncRoot
	pushq	%rbp
...
.LBB0_1:                                # %"5"
	...
	callq	__assert_fail
.Lfunc_end0:
	.size	LogLuvEncode24.5, .Lfunc_end0-LogLuvEncode24.5
	.cfi_endproc
                                        # -- End function
	.hidden	.str.1
	.hidden	.str.5
