	.text
	.file	"tif_luv.c"
	.globl	LogL16InitState.2       # -- Begin function LogL16InitState.2
	.p2align	4, 0x90
	.type	LogL16InitState.2,@function
LogL16InitState.2:                      # @LogL16InitState.2
	.cfi_startproc
# %bb.0:                                # %newFuncRoot
	pushq	%rbp
...
.LBB0_1:                                # %"2"
	...
	callq	__assert_fail
		...
		.byte 0x64, 0x67, 0x90
.Lfunc_end0:
	.size	LogL16InitState.2, .Lfunc_end0-LogL16InitState.2
	.cfi_endproc
                                        # -- End function
	.hidden	.str.1
	.hidden	.str.5
