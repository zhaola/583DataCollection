	.text
	.file	"tif_predict.c"
	.globl	swabHorAcc16.10         # -- Begin function swabHorAcc16.10
	.p2align	4, 0x90
	.type	swabHorAcc16.10,@function
swabHorAcc16.10:                        # @swabHorAcc16.10
	.cfi_startproc
# %bb.0:                                # %newFuncRoot
	pushq	%rbp
...
.LBB0_2:                                # %"10"
	...
	movq	%rax, (%rdi)
		...
		.byte 0x64, 0x67, 0x90
.Lfunc_end0:
	.size	swabHorAcc16.10, .Lfunc_end0-swabHorAcc16.10
	.cfi_endproc
                                        # -- End function
