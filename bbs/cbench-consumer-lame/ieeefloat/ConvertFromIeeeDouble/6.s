	...
	.p2align	3               # -- Begin function ConvertFromIeeeDouble.6
.LCPI0_0:
	.quad	4746794007248502784     # double 2147483648
	.text
	.globl	ConvertFromIeeeDouble.6
	.p2align	4, 0x90
	.type	ConvertFromIeeeDouble.6,@function
ConvertFromIeeeDouble.6:                # @ConvertFromIeeeDouble.6
	.cfi_startproc
# %bb.0:                                # %newFuncRoot
	pushq	%rbp
...
.LBB0_2:                                # %"6"
	...
	movsd	%xmm0, (%rbx)
		...
		.byte 0x64, 0x67, 0x90
.Lfunc_end0:
	.size	ConvertFromIeeeDouble.6, .Lfunc_end0-ConvertFromIeeeDouble.6
	.cfi_endproc
                                        # -- End function
