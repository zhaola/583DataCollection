	...
	.p2align	2               # -- Begin function fft_long.7
.LCPI0_0:
	.long	1060439283              # float 0.707106769
	.text
	.globl	fft_long.7
	.p2align	4, 0x90
	.type	fft_long.7,@function
fft_long.7:                             # @fft_long.7
	.cfi_startproc
# %bb.0:                                # %newFuncRoot
	pushq	%rbp
...
.LBB0_2:                                # %"7"
	...
	movq	__profc_fft_long+8, %rbx
	addq	$1, %rbx
	movq	%rbx, __profc_fft_long+8
	movswq	(%rdi), %rdi
	...
	movss	%xmm0, 2060(%rax)
		...
		.byte 0x64, 0x67, 0x90
.Lfunc_end0:
	.size	fft_long.7, .Lfunc_end0-fft_long.7
	.cfi_endproc
                                        # -- End function
	.hidden	rv_tbl
	.hidden	window
