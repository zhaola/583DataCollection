	.text
	.file	"rdgif.c"
	.globl	LZWReadByte.18          # -- Begin function LZWReadByte.18
	.p2align	4, 0x90
	.type	LZWReadByte.18,@function
LZWReadByte.18:                         # @LZWReadByte.18
	.cfi_startproc
# %bb.0:                                # %newFuncRoot
	pushq	%rbp
...
.LBB0_2:                                # %"18"
	...
	movl	$0, (%r14)
		...
		.byte 0x64, 0x67, 0x90
.Lfunc_end0:
	.size	LZWReadByte.18, .Lfunc_end0-LZWReadByte.18
	.cfi_endproc
                                        # -- End function
