	.text
	.file	"jdatadst.c"
	.globl	term_destination.5      # -- Begin function term_destination.5
	.p2align	4, 0x90
	.type	term_destination.5,@function
term_destination.5:                     # @term_destination.5
	.cfi_startproc
# %bb.0:                                # %newFuncRoot
	pushq	%rbp
...
.LBB0_2:                                # %"5"
	...
	jmp	.LBB0_1
.Lfunc_end0:
	.size	term_destination.5, .Lfunc_end0-term_destination.5
	.cfi_endproc
                                        # -- End function
