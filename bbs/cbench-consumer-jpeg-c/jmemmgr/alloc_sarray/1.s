	.text
	.file	"jmemmgr.c"
	.globl	alloc_sarray.1          # -- Begin function alloc_sarray.1
	.p2align	4, 0x90
	.type	alloc_sarray.1,@function
alloc_sarray.1:                         # @alloc_sarray.1
	.cfi_startproc
# %bb.0:                                # %newFuncRoot
	pushq	%rbp
...
.LBB0_2:                                # %"1"
	...
	jmp	.LBB0_1
.Lfunc_end0:
	.size	alloc_sarray.1, .Lfunc_end0-alloc_sarray.1
	.cfi_endproc
                                        # -- End function
