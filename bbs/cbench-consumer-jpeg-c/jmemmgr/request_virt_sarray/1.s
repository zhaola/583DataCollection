...
.LBB0_2:                                # %"1"
	.cfi_def_cfa %rbp, 16
	movabsq	$__profd_.._jmemmgr.c_request_virt_sarray, %rax
	movq	__profc_.._jmemmgr.c_request_virt_sarray+8, %rcx
	addq	$1, %rcx
	movq	%rcx, __profc_.._jmemmgr.c_request_virt_sarray+8
	movq	(%rdi), %rcx
	movq	(%rcx), %rcx
	movl	$12, 40(%rcx)
	movl	(%rsi), %ecx
