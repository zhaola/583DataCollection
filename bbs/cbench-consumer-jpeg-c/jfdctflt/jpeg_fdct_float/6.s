	...
	.p2align	2               # -- Begin function jpeg_fdct_float.6
.LCPI0_0:
...
.LCPI0_3:
	...
	.text
	.globl	jpeg_fdct_float.6
	.p2align	4, 0x90
	.type	jpeg_fdct_float.6,@function
jpeg_fdct_float.6:                      # @jpeg_fdct_float.6
	.cfi_startproc
# %bb.0:                                # %newFuncRoot
	pushq	%rbp
...
.LBB0_2:                                # %"6"
	...
	movss	%xmm4, (%r8)
	movq	(%rdi), %rbx
	movss	64(%rbx), %xmm4         # xmm4 = mem[0],zero,zero,zero
	movq	(%rdi), %rbx
	addss	160(%rbx), %xmm4
	movss	%xmm4, (%r9)
	movq	(%rdi), %rbx
	...
	movss	%xmm4, (%rax)
	movq	(%rdi), %rbx
	movss	96(%rbx), %xmm4         # xmm4 = mem[0],zero,zero,zero
	movq	(%rdi), %rbx
	addss	128(%rbx), %xmm4
	movss	%xmm4, (%r15)
	movq	(%rdi), %rbx
	...
	movq	%rax, (%rdi)
		...
		.byte 0x64, 0x67, 0x90
.Lfunc_end0:
	.size	jpeg_fdct_float.6, .Lfunc_end0-jpeg_fdct_float.6
	.cfi_endproc
                                        # -- End function
