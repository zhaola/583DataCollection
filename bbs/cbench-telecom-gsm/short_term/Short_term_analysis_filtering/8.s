	.text
	.file	"short_term.c"
	.globl	Short_term_analysis_filtering.8 # -- Begin function Short_term_analysis_filtering.8
	.p2align	4, 0x90
	.type	Short_term_analysis_filtering.8,@function
Short_term_analysis_filtering.8:        # @Short_term_analysis_filtering.8
	.cfi_startproc
# %bb.0:                                # %newFuncRoot
	pushq	%rbp
...
.LBB0_2:                                # %"8"
	...
	movq	%rax, (%rsi)
		...
		.byte 0x64, 0x67, 0x90
.Lfunc_end0:
	.size	Short_term_analysis_filtering.8, .Lfunc_end0-Short_term_analysis_filtering.8
	.cfi_endproc
                                        # -- End function
