	.text
	.file	"wrgif.c"
	.globl	finish_output_gif.1     # -- Begin function finish_output_gif.1
	.p2align	4, 0x90
	.type	finish_output_gif.1,@function
finish_output_gif.1:                    # @finish_output_gif.1
	.cfi_startproc
# %bb.0:                                # %newFuncRoot
	pushq	%rbp
...
.LBB0_2:                                # %"1"
	...
	jmp	.LBB0_1
.Lfunc_end0:
	.size	finish_output_gif.1, .Lfunc_end0-finish_output_gif.1
	.cfi_endproc
                                        # -- End function
