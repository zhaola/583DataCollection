	.text
	.file	"wrtarga.c"
	.globl	start_output_tga.3      # -- Begin function start_output_tga.3
	.p2align	4, 0x90
	.type	start_output_tga.3,@function
start_output_tga.3:                     # @start_output_tga.3
	.cfi_startproc
# %bb.0:                                # %newFuncRoot
	pushq	%rbp
...
.LBB0_2:                                # %"3"
	...
	movq	%rcx, 8(%rax)
		...
		.byte 0x64, 0x67, 0x90
.Lfunc_end0:
	.size	start_output_tga.3, .Lfunc_end0-start_output_tga.3
	.cfi_endproc
                                        # -- End function
