	.text
	.file	"rdcolmap.c"
	.globl	read_gif_map.16         # -- Begin function read_gif_map.16
	.p2align	4, 0x90
	.type	read_gif_map.16,@function
read_gif_map.16:                        # @read_gif_map.16
	.cfi_startproc
# %bb.0:                                # %newFuncRoot
	pushq	%rbp
...
.LBB0_2:                                # %"16"
	...
	callq	*%rbx
		...
		.byte 0x64, 0x67, 0x90
.Lfunc_end0:
	.size	read_gif_map.16, .Lfunc_end0-read_gif_map.16
	.cfi_endproc
                                        # -- End function
