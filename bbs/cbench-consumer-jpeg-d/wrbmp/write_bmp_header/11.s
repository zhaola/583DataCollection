	.text
	.file	"wrbmp.c"
	.globl	write_bmp_header.11     # -- Begin function write_bmp_header.11
	.p2align	4, 0x90
	.type	write_bmp_header.11,@function
write_bmp_header.11:                    # @write_bmp_header.11
	.cfi_startproc
# %bb.0:                                # %newFuncRoot
	pushq	%rbp
...
.LBB0_2:                                # %"11"
	...
	callq	*%rbx
		...
		.byte 0x64, 0x67, 0x90
.Lfunc_end0:
	.size	write_bmp_header.11, .Lfunc_end0-write_bmp_header.11
	.cfi_endproc
                                        # -- End function
