	.text
	.file	"tif_dir.c"
	.globl	TIFFAdvanceDirectory.13 # -- Begin function TIFFAdvanceDirectory.13
	.p2align	4, 0x90
	.type	TIFFAdvanceDirectory.13,@function
TIFFAdvanceDirectory.13:                # @TIFFAdvanceDirectory.13
	.cfi_startproc
# %bb.0:                                # %newFuncRoot
	pushq	%rbp
...
.LBB0_3:                                # %"13"
	...
	cmpl	$2, %eax
		...
		.byte 0x64, 0x67, 0x90
.Lfunc_end0:
	.size	TIFFAdvanceDirectory.13, .Lfunc_end0-TIFFAdvanceDirectory.13
	.cfi_endproc
                                        # -- End function
