	.text
	.file	"tif_luv.c"
	.globl	LogLuvInitState.9       # -- Begin function LogLuvInitState.9
	.p2align	4, 0x90
	.type	LogLuvInitState.9,@function
LogLuvInitState.9:                      # @LogLuvInitState.9
	.cfi_startproc
# %bb.0:                                # %newFuncRoot
	pushq	%rbp
...
.LBB0_2:                                # %"9"
	...
	movl	%eax, (%rcx)
		...
		.byte 0x64, 0x67, 0x90
.Lfunc_end0:
	.size	LogLuvInitState.9, .Lfunc_end0-LogLuvInitState.9
	.cfi_endproc
                                        # -- End function
